...
for (let i = 0; i < starWarsCharacters.length; i++){
  switch(true){
    ...
    case totalMass > 900:
      ...
      break;
    case totalMass > 1000:
      console.log("Danger!Overload alert:Jump ship ");
  }    
}
...
/*function personaggioRandom(){
  let index = getRandomiInt( 0, total)
  let starWarsCharacters[index];

  console.log(`Il suo nome è ${character.name},la sua altezza è ${character.height} un ${character.gender} con capelli ${character.hair_color}  e occhi ${character.eye_color} `)
}
